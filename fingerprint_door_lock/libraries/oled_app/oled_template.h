#ifndef OLED_TEMPLATE_H
#define OLED_TEMPLATE_H
...
// ====== BITMAP ICONS (MONOCHROME) ======
// Fingerprint icon: 24x24
const unsigned char fingerprint_24x24[] PROGMEM = {
  0x00,0x7E,0x00,
  0x01,0xFF,0x80,
  0x03,0xC3,0xC0,
  0x07,0x81,0xE0,
...
// RFID card icon: 24x16
const unsigned char card_24x16[] PROGMEM = {
  0xFF,0xFF,0xFF,
  0x80,0x00,0x01,
  0x80,0x00,0x01,
  0x80,0x00,0x01,
